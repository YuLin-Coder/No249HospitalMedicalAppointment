<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">医院医疗预约服务管理信息系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="手机号码" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.shoujihaoma" autocomplete="off" placeholder="手机号码"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			...
			<el-form-item label="医院地址" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.yiyuandizhi" autocomplete="off" placeholder="医院地址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yisheng'" class="input-group">
			   <div class="label">科室地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.keshidizhi" class="input" type="text" placeholder="科室地址">
			   </div>
			 </div> -->
			<el-form-item label="科室地址" class="input" v-if="tableName=='yisheng'">
			  <el-input v-model="ruleForm.keshidizhi" autocomplete="off" placeholder="科室地址"  />
			</el-form-item>
