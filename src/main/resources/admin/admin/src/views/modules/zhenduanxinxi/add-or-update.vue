<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="诊断名称" prop="zhenduanmingcheng">
          <el-input v-model="ruleForm.zhenduanmingcheng" 
              placeholder="诊断名称" clearable  :readonly="ro.zhenduanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="诊断名称" prop="zhenduanmingcheng">
              <el-input v-model="ruleForm.zhenduanmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="诊断日期" prop="zhenduanriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhenduanriqi" label="诊断日期" prop="zhenduanriqi">
              <el-input v-model="ruleForm.zhenduanriqi" 
                placeholder="诊断日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.bingqingjilu" label="病情记录" prop="bingqingjilu">
                    <span>{{ruleForm.bingqingjilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshimingcheng = true;
          ...
          if(o=='zhenduanmingcheng'){
            this.ruleForm.zhenduanmingcheng = obj[o];
	    this.ro.zhenduanmingcheng = true;
            continue;
          }
          if(o=='bingqingjilu'){
	...
	this.ruleForm.zhenduanneirong = this.ruleForm.zhenduanneirong.replace(reg,'../../../springbootg15ia/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
