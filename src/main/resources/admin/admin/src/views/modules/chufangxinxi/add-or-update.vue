<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="处方名称" prop="chufangmingcheng">
          <el-input v-model="ruleForm.chufangmingcheng" 
              placeholder="处方名称" clearable  :readonly="ro.chufangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="处方名称" prop="chufangmingcheng">
              <el-input v-model="ruleForm.chufangmingcheng" 
                placeholder="处方名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yaopinmingcheng" label="药品名称" prop="yaopinmingcheng">
  ...
  methods: {
    ...
    yaopinmingchengChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              if(data.data.danjia){
                this.ruleForm.danjia = data.data.danjia
              }
        } else {
          this.$message.error(data.msg);
        }
