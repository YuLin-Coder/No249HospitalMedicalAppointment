<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服用方式" prop="fuyongfangshi">
          <el-input v-model="ruleForm.fuyongfangshi" 
              placeholder="服用方式" clearable  :readonly="ro.fuyongfangshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服用方式" prop="fuyongfangshi">
              <el-input v-model="ruleForm.fuyongfangshi" 
                placeholder="服用方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopingongxiao = true;
          ...
          if(o=='fuyongfangshi'){
            this.ruleForm.fuyongfangshi = obj[o];
	    this.ro.fuyongfangshi = true;
            continue;
          }
          if(o=='danjia'){
