<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体检名称" prop="tijianmingcheng">
          <el-input v-model="ruleForm.tijianmingcheng" 
              placeholder="体检名称" clearable  :readonly="ro.tijianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体检名称" prop="tijianmingcheng">
              <el-input v-model="ruleForm.tijianmingcheng" 
                placeholder="体检名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="提醒信息" prop="tixingxinxi">
          <el-input v-model="ruleForm.tixingxinxi" 
              placeholder="提醒信息" clearable  :readonly="ro.tixingxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="提醒信息" prop="tixingxinxi">
              <el-input v-model="ruleForm.tixingxinxi" 
                placeholder="提醒信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.beizhu = true;
          ...
          if(o=='tixingxinxi'){
            this.ruleForm.tixingxinxi = obj[o];
	    this.ro.tixingxinxi = true;
            continue;
          }
          if(o=='fasongriqi'){
