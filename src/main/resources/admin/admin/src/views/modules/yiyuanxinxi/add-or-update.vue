<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院长" prop="yuanzhang">
          <el-input v-model="ruleForm.yuanzhang" 
              placeholder="院长" clearable  :readonly="ro.yuanzhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院长" prop="yuanzhang">
              <el-input v-model="ruleForm.yuanzhang" 
                placeholder="院长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="医院详情" prop="yiyuanxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yiyuanxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yiyuanxiangqing" label="医院详情" prop="yiyuanxiangqing">
                    <span v-html="ruleForm.yiyuanxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yiyuantupian = true;
          ...
          if(o=='yuanzhang'){
            this.ruleForm.yuanzhang = obj[o];
	    this.ro.yuanzhang = true;
            continue;
          }
          if(o=='chenglishijian'){
	    ...
	    this.ro.yiyuanjianjie = true;
          ...
          if(o=='yiyuanxiangqing'){
            this.ruleForm.yiyuanxiangqing = obj[o];
	    this.ro.yiyuanxiangqing = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.yiyuanxiangqing = this.ruleForm.yiyuanxiangqing.replace(reg,'../../../springbootg15ia/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
