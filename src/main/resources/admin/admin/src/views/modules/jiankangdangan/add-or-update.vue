<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="血压pa" prop="xueyapa">
          <el-input v-model="ruleForm.xueyapa" 
              placeholder="血压pa" clearable  :readonly="ro.xueyapa"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="血压pa" prop="xueyapa">
              <el-input v-model="ruleForm.xueyapa" 
                placeholder="血压pa" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="血糖g" prop="xuetangg">
          <el-input v-model="ruleForm.xuetangg" 
              placeholder="血糖g" clearable  :readonly="ro.xuetangg"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="血糖g" prop="xuetangg">
              <el-input v-model="ruleForm.xuetangg" 
                placeholder="血糖g" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="睡眠时间" prop="shuimianshijian">
          <el-input v-model="ruleForm.shuimianshijian" 
              placeholder="睡眠时间" clearable  :readonly="ro.shuimianshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="睡眠时间" prop="shuimianshijian">
              <el-input v-model="ruleForm.shuimianshijian" 
                placeholder="睡眠时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运动情况" prop="yundongqingkuang">
          <el-input v-model="ruleForm.yundongqingkuang" 
              placeholder="运动情况" clearable  :readonly="ro.yundongqingkuang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运动情况" prop="yundongqingkuang">
              <el-input v-model="ruleForm.yundongqingkuang" 
                placeholder="运动情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tizhongkg = true;
          ...
          if(o=='xueyapa'){
            this.ruleForm.xueyapa = obj[o];
	    this.ro.xueyapa = true;
            continue;
          }
          if(o=='xuetangg'){
            this.ruleForm.xuetangg = obj[o];
	    this.ro.xuetangg = true;
            continue;
          }
          if(o=='tiwen'){
	    ...
	    this.ro.tiwen = true;
          ...
          if(o=='shuimianshijian'){
            this.ruleForm.shuimianshijian = obj[o];
	    this.ro.shuimianshijian = true;
            continue;
          }
