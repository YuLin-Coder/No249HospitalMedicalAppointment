  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zixunfengmian" label="资讯封面" prop="zixunfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zixunfengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../springbootg15ia/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
