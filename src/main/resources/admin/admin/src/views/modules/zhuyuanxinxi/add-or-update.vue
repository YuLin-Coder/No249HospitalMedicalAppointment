<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="住院名称" prop="zhuyuanmingcheng">
          <el-input v-model="ruleForm.zhuyuanmingcheng" 
              placeholder="住院名称" clearable  :readonly="ro.zhuyuanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="住院名称" prop="zhuyuanmingcheng">
              <el-input v-model="ruleForm.zhuyuanmingcheng" 
                placeholder="住院名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="住院日期" prop="zhuyuanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zhuyuanriqi" 
                type="date"
                :readonly="ro.zhuyuanriqi"
                placeholder="住院日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuyuanriqi" label="住院日期" prop="zhuyuanriqi">
              <el-input v-model="ruleForm.zhuyuanriqi" 
                placeholder="住院日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="住院备注" prop="zhuyuanbeizhu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="住院备注"
                  v-model="ruleForm.zhuyuanbeizhu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyuanbeizhu" label="住院备注" prop="zhuyuanbeizhu">
                    <span>{{ruleForm.zhuyuanbeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshimingcheng = true;
          ...
          if(o=='zhuyuanmingcheng'){
            this.ruleForm.zhuyuanmingcheng = obj[o];
	    this.ro.zhuyuanmingcheng = true;
            continue;
          }
          if(o=='feiyong'){
	    ...
	    this.ro.feiyong = true;
          ...
          if(o=='zhuyuanriqi'){
            this.ruleForm.zhuyuanriqi = obj[o];
	    this.ro.zhuyuanriqi = true;
            continue;
          }
          if(o=='zhuyuanbeizhu'){
            this.ruleForm.zhuyuanbeizhu = obj[o];
	    this.ro.zhuyuanbeizhu = true;
            continue;
          }
          if(o=='zhanghao'){
