  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="医院名称" prop="yiyuanmingcheng">
		  <el-select  @change="yiyuanmingchengChange" clearable v-model="searchForm.yiyuanmingcheng" placeholder="请选择医院名称">
		    <el-option
		...
		<el-form-item class="select" label="科室名称" prop="keshimingcheng">
